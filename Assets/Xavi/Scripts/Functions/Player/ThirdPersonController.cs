...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Sensibility of the mouse")]
        public float _sensibility = 0.5f;
        [Tooltip("If is activated Player couldn't be able to move")]
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                float deltaTimeMultiplier = IsCurrentDeviceMouse ? _sensibility : Time.deltaTime;
        ...
        private void Move()
        {
            ...
            if ((_input.shield || StarterAssets.AnimController.Instance.Attacking) && (Grounded) && (GetComponent<GunController>().isarmed)) _targetspeed = _targetspeed / 2;
